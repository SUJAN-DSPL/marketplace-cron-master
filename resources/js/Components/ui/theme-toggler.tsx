    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                ...
                >
                    <WbSunnyIcon className="h-[0.1rem] w-[0.1rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0" />
                    <DarkModeIcon className="absolute h-[0.1rem] w-[0.1rem] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100" />
